...
#define WALL_FOLLOW_DISTANCE 0.5
#define WALL_FOLLOW_SPEED 1.5
#define WALL_ANGLE 0.0
#define WALL_MAX_THRESH 1.5

#define OBJ_REACHED_DIST 0.6

/* TUNABLE CONSTANTS */
#define ANGLE_CONTROL_P 10.0
#define ANGLE_CONTROL_I 0.0
#define ANGLE_CONTROL_D 5.0
#define DIST_CONTROL_P 10.0
#define DIST_CONTROL_I 0.0
#define DIST_CONTROL_D 5.0
...
*/
		...
		ROS_INFO("Got x2: %f", x2);
	      ...
	      index2 = j;
            ...
            if (x1 > WALL_MAX_THRESH || x2 > WALL_MAX_THRESH) {
              noMoreWall = 1;
              break;
            } else {
              noMoreWall = 0;
            ...
            double rad = (double)(index1-index2) / PIXEL_PER_DEGREE * PI / 180; //true distance
